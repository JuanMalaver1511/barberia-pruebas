	...
	<div class="login formulario">
		<form class="login-container validate-form " name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
			<span class="login100-form-title p-b-32">
				Administra tu barberia
			<img src="../Design/images/avatar.gif" class="avatar">
			</span>
			<style>
				.login100-form-title {
        			display: flex;
				...
				.formulario{
					border-radius: 10px;
					background: linear-gradient(to bottom right, #877f80, #393536);
				}
				.formulario input{
					border-radius: 10px;
					background: linear-gradient(to bottom right, #6ea0e0, #db5f70);
			...
			<div class="form-input">
				...
				<input type="text" name="username" class="form-control" oninput="this.style.color = 'white'; getElementById('required_username').style.display = 'none'" autocomplete="off">
			...
			<div class="form-input">
				...
				<input type="password" name="password" class="form-control" oninput="this.style.color = 'white'; getElementById('required_password').style.display = 'none'" autocomplete="new-password">
	...
	<footer class="sticky-footer bg-white">
		<div class="container my-auto">
			<div class="copyright text-center my-auto">
				<span><a href="https://nexustech.pages.dev/">Para más desarrollos Nexustech</a></span>
			</div>
		</div>
	</footer>
	<!-- End of Footer -->
