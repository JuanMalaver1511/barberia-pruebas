...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://nexustech.pages.dev/" target="_blank">
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="../" target="_blank">
								<i class="far fa-eye" style="color: #1984bc "></i>
								<span style="margin-left: 5px; color: #1984bc ">Ver Sitio Web</span>
							</a>
						</li>
