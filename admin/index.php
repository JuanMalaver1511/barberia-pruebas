...
?>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="bs bs-boy fa-2x text-black-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="bs bs-scissors-1 fa-2x text-black-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="bs bs-man fa-2x text-black-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <tbody>
        ...
        if ($count == 0) {
            ...
            foreach ($rows as $row) {
                ...
                $date = $row['start_time'];
                // Formatear la fecha en el formato adecuado para WhatsApp
                $date_for_whatsapp = date('d-m-Y', strtotime($date));
                // Crear el mensaje para WhatsApp
                $message = urlencode("Recuerda que tienes una cita para el $date_for_whatsapp. No lo olvides.");
                // Crear el enlace de WhatsApp con el mensaje y el número de teléfono del cliente
                $whatsapp_link = "https://wa.me/$phone_number/?text=$message";
                // Imprimir el enlace
                echo "<a href='$whatsapp_link' target='_blank'  class='whatsapp-link'><i class='fab fa-whatsapp'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        }
    ...
    .whatsapp-link:hover {
        transform: scale(1.2); /* Escalar al 120% al hacer hover */
    }
</style>
